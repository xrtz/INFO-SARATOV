...
info = {'Саратов': "Саратов — город на юго-востоке европейской части России, "
        ...
        "Панорама": "Панорамный ресторан занял первое место в нашем списке. Своей популярностью он обязан удачному "
                    ...
                    " Здесь проводят любые мероприятия: отмечают"
                    ...
                    "европейские, кавказские, русские блюда. Не обходится и без авторских деликатесов "
                    "от известного шеф-повара. В заведении есть сцена для выступления "
                    "профессиональных музыкантов, танцпол, караоке. Ресторан располагает собственной охраняемой "
                    "территорией, на"
                    " которой предусмотрены парковочные места. Он открыт с 11 до полуночи. "
                    "Телефон администратора: 88452754065.",
